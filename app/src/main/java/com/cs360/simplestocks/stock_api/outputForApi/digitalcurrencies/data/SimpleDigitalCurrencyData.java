package com.cs360.simplestocks.stock_api.outputForApi.digitalcurrencies.data;
 ...
 * }
 */
public class SimpleDigitalCurrencyData {
    ...
    public SimpleDigitalCurrencyData(LocalDateTime parse,
                                     double priceA,
                                     double priceB,
                                     double volume,
                                     double marketCap) {
